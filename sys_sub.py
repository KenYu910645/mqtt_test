...
def on_connect(client, userdata, flags, rc):
    ...
    print "the private user data as set in Client() or user_data_set() : " , str(userdata) 
    print "response flags sent by the broker : ", flags
    print("the connection result "+str(rc))
    if rc == 0 : 
...
#while True:
#    client.loop()
# loop_start () # Start Network engine at background (free up main thread) 
...
# subscribe([("my/topic", 0), ("another/topic", 2)]) # Subcribe to multi topic.
